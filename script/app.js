...
// test
const slidedata = document.querySelector('.about__data')
window.addEventListener('scroll', () =>{
    ...
    if(scrollTop > (scrollTop + topElementToTopViewport).toFixed()- clientHeight*0.80){
        slidedata.classList.add('active')
    }
})

const slideimg = document.querySelector('.about__img')
window.addEventListener('scroll', () =>{
    const {scrollTop, clientHeight} =
    document.documentElement;
...
const slideproject = document.querySelector('.project__bg')
window.addEventListener('scroll', () =>{
    const {scrollTop, clientHeight} =
    document.documentElement;
    ...
    if(scrollTop > (scrollTop + topElementToTopViewport).toFixed()- clientHeight*0.50){
        slideproject.classList.add('active')
    }
})
